...
title: 'Packtrail: workflow durevoli costruiti solo su NATS'
...
cover:
    ...
    alt: "Packtrail, un workflow engine durevole in Go costruito su NATS JetStream, KV e Message Scheduler"
    caption: ""
    relative: false
    hidden: false
---
