...
title: 'Prototype like anyone, ship like an engineer: ground rules for the AI-first company'
...
featuredImage: "/images/ai004.png"
images: ["/images/ai004.png"]
code:
  maxShownLines: -1
cover:
    image: "/images/ai004.png" # image path/url
