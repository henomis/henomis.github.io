...
title: 'Packtrail: durable workflows built on nothing but NATS'
tags: ["go", "nats", "workflow", "open-source", "packtrail"]
showToc: true
TocOpen: false
draft: false
hidemeta: false
...
featuredImage: "/images/packtrail001.png"
images: ["/images/packtrail001.png"]
code:
  maxShownLines: -1
cover:
    image: "/images/packtrail001.png"
    alt: "Packtrail, a durable workflow engine in Go built on NATS JetStream, KV and the Message Scheduler"
    caption: ""
    relative: false
    hidden: false
---
